...
/**
 * NuMap giriş rozetini üst şeritteki yuvaya taşır.
 *
 ...
 * build sırasında `</head>` içine enjekte edildiği için `<body>` henüz
 * ayrıştırılmamış olur ve yuvayı hiçbir zaman bulamaz — rozet de üst menünün
 * üstüne biner.
 *
 * Paylaşılan gate dosyası NuMap'ten birebir kopyalandığı için ona
 ...
 */
export function useKimlikYuvasi() {
  useEffect(() => {
