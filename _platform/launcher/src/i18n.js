...
export const STRINGS = {
  ...
  ku: {
    ...
    platform_tagline:
      'Ji bo her xwendekarê her temenê matematîkeke konkret, dîtbar û sezgîbar — bi manîpulatîfên destan 7 amûr, bi 3 zimanan.',
    platform_hero_cta: 'Amûran Keşf Bike',
    open_tool: 'Veke',
    all_tools: 'Hemû Amûr',
    by_category: 'Kategoriyên Mijarê',
    by_age: 'Koma Temen',
    age_all: 'Hemû Temen',
    age_early: 'Zû (5-7)',
    ...
    framework: 'Nêzîkatî',
    topics: 'Mijar',
    search_placeholder: 'Amûr an mijar bigere...',
    no_results: 'Encam nehat dîtin.',
    author: 'Prof. Dr. Yılmaz Mutlu',
    about: 'Derbarê DokunSay',
    about_body:
      'DokunSay, ji bo xwendekarên 5-15 salî yên her astekê malbata amûrên fêrkirina matematîkê ye. Heft amûr bingeha bernameya matematîkê digire: hejmar & kirarî, parjimar, hejmara tam, saet, cîyometrî û xwendewariya daneyan. Her amûr veguheztina Konkret → Nîv-Soyut → Soyut (CRA) piştgirî dike; li ser çarçoveyên pedagojîk ên lêkolînî (Van Hiele, Curcio, Bloom, Piaget) hatiye avakirin. Taybetmendiyên piştgiriya diskalkulî (hedefên mezin ên destan, paleta koririya rengan, xwendina bi deng, kontrasta bilind) di her amûrekê de hene.',
    why_title: 'Çima DokunSay?',
    why_subtitle: 'Ji bo her zarokekî hatiye çêkirin, ji bo her mamosteyî amade.',
    feature_research_title: 'Lêkolînî',
    feature_research_body:
      'Li ser çarçoveyên pedagojîk ên wek Van Hiele, Curcio, Bloom, Piaget, Bruner ava bûye.',
    feature_multilingual_title: 'Pirzimanî',
    feature_multilingual_body:
      'Tirkî, Kurmancî û Îngilîzî. Bi terminolojiya matematîkê ya FerMat hevahengkirî.',
    feature_inclusive_title: 'Ji Bo Her Kesekî',
    feature_inclusive_body:
      'Modên taybet ji bo diskalkulî, disleksî û koririya rengan. WCAG AA lihevhatî.',
    feature_manipulative_title: 'Bingeha Manîpulatîf',
    feature_manipulative_body:
      'Berî derbasbûna sembolên soyut, bi nesneyên konkret danûstandin. Bi destan fêrbûn.',
    stats_tools: 'Amûrên Fêrkirinê',
    stats_languages: 'Ziman',
    stats_activities: 'Çalakî',
    stats_frameworks: 'Çarçoveya Pedagojîk',
    lang_btn: 'Ziman',
    accessibility: 'Gihîştin',
    high_contrast: 'Kontrasta Bilind',
    dyscalculia_mode: 'Moda Diskalkulî',
    standards_link: 'Standardên Platformê',
    back_to_menu: 'Vegere Menuyê',
    open_in_new_tab: 'Di tabeke nû de veke',
    loading_tool: 'Amûr tê barkirin',
    tool_not_running_title: 'Amûr naxebite',
    tool_not_running_body:
      'Ev amûr niha naxebite. Di pêşxistinê de divê her amûrek li termînalên cuda dest pê bike:',
    tool_not_running_hint: 'Piştî destpêkirina amûrê li "Ji Nû Ve Biceribîne" bitikîne.',
    retry: 'Ji Nû Ve Biceribîne',
    fullscreen: 'Tam Ekran',
    exit_fullscreen: 'Ji Tam Ekranê Derkeve',
  },
  en: {
    platform_title: 'DokunSay',
