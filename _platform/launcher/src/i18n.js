...
export const STRINGS = {
  tr: {
    ...
    traj_scope: '20 yörünge · 223 basamak · 5 öğrenme alanı',
  ...
  ku: {
    ...
    traj_scope: '20 hêl · 223 pêngav · 5 warê fêrbûnê',
    ...
    rehber_nav: 'Rêbera Destwerdanê',
    rehber_desc: '10 rêbazên fêrkirinê yên herî bibandor ji bo diskalkulî û zehmetiya matematîkê — li ser bingeha IES/WWC û meta-analîzan, her yek bi mînakên polê tê nîşandan.',
    rehber_scope: '10 rêbazên li ser bingeha delîlan',
    rehber_explore: 'Rêberê veke',
    set_nav: 'Çovikên Hejmaran ên Xalî',
    set_desc: 'Setek çovikên hejmaran a konkret ku hejmaran hem bi dîtinê hem bi destlêdanê hîn dike — matematîka destpêkê bi çovikên xalî yên 1–10, pul û çarçoveyan.',
    set_scope: 'Materyalê konkret · Asta Kesk',
    set_explore: 'Setê binêre',
    tools_nav: 'Amûr',
    tools_section_title: 'Amûrên Dîjîtal û Konkret',
    tools_section_sub: 'Sepanên dîjîtal ên bi destlêdanê û setek materyalê konkret — bi hev re, di 5 zimanan de.',
    open_tool: 'Veke',
    all_tools: 'Hemû Amûr',
  ...
  en: {
    ...
    traj_scope: '20 trajectories · 223 levels · 5 learning areas',
    ...
    rehber_nav: 'Intervention Guide',
    rehber_desc: 'The 10 most effective teaching methods for dyscalculia and mathematics difficulty — grounded in IES/WWC and meta-analyses, each shown with classroom examples.',
    rehber_scope: '10 evidence-based methods',
    rehber_explore: 'Open the guide',
    set_nav: 'Dotted Number Rods',
    set_desc: 'A concrete number-rod set that teaches numbers by sight and by touch — early mathematics with dotted rods 1–10, chips and frames.',
    set_scope: 'Concrete material · Green Level',
    set_explore: 'View the set',
    tools_nav: 'Tools',
    tools_section_title: 'Virtual and Concrete Tools',
    tools_section_sub: 'Touch-based digital apps and a concrete material set — together, in 5 languages.',
    open_tool: 'Open',
    all_tools: 'All Tools',
  ...
  ar: {
    ...
    traj_scope: '٢٠ مساراً · ٢٢٣ خطوة · ٥ مجالات تعلّم',
    traj_h_age: 'تصفّح حسب العمر',
    traj_h_lvl: 'تتبّع المستوى الفردي',
    traj_h_tool: 'أداة لكلّ خطوة',
    traj_explore: 'استكشف المسارات',
    rehber_nav: 'دليل التدخّل',
    rehber_desc: 'أنجع ١٠ طرائق تدريس لعسر الحساب وصعوبات الرياضيات — مبنيّة على IES/WWC والتحليلات البعدية، مع أمثلة صفّية لكلٍّ منها.',
    rehber_scope: '١٠ طرائق قائمة على الأدلّة',
    rehber_explore: 'افتح الدليل',
    set_nav: 'قضبان الأعداد المنقّطة',
    set_desc: 'طقم قضبان أعداد ملموس يعلّم الأعداد بالنظر واللمس معاً — رياضيات مبكّرة بقضبان منقّطة من ١ إلى ١٠ ورقاقات وأطر.',
    set_scope: 'مادّة ملموسة · المستوى الأخضر',
    set_explore: 'استعرض الطقم',
    tools_nav: 'الأدوات',
    tools_section_title: 'أدوات افتراضية وملموسة',
    tools_section_sub: 'تطبيقات رقمية تعمل باللمس وطقم مادّة ملموسة — معاً، بخمس لغات.',
    open_tool: 'افتح',
  ...
  fa: {
    ...
    traj_scope: '۲۰ مسیر · ۲۲۳ پله · ۵ حوزهٔ یادگیری',
    traj_h_age: 'مرور بر اساس سن',
    traj_h_lvl: 'پیگیری سطح فردی',
    traj_h_tool: 'ابزاری برای هر پله',
    traj_explore: 'کاوش مسیرها',
    rehber_nav: 'راهنمای مداخله',
    rehber_desc: '۱۰ روش آموزشی مؤثر برای اختلال ریاضی و دشواری‌های ریاضی — بر پایهٔ IES/WWC و فراتحلیل‌ها، هر کدام با نمونه‌های کلاسی.',
    rehber_scope: '۱۰ روش مبتنی بر شواهد',
    rehber_explore: 'راهنما را باز کن',
    set_nav: 'میله‌های عددی خال‌دار',
    set_desc: 'مجموعهٔ میله‌های عددی محسوس که اعداد را با دیدن و لمس‌کردن می‌آموزد — ریاضی آغازین با میله‌های خال‌دار ۱ تا ۱۰، ژتون‌ها و قاب‌ها.',
    set_scope: 'مادهٔ محسوس · سطح سبز',
    set_explore: 'مجموعه را ببین',
    tools_nav: 'ابزارها',
    tools_section_title: 'ابزارهای مجازی و محسوس',
    tools_section_sub: 'اپلیکیشن‌های دیجیتال لمسی و مجموعهٔ مادهٔ محسوس — با هم، به ۵ زبان.',
    open_tool: 'باز کن',
