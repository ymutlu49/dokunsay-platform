...
<header class="dk-a-hero">
  <div class="wrap">
    <span class="dk-a-hero-eyebrow">Ücretsiz · Tarayıcıda Çalışır · TR/KU/EN/AR/FA</span>
    <h1>DokunSay — <span class="grad">7 interaktif matematik öğretim aracı</span></h1>
    <p>Somut, görsel ve sezgisel öğretim. Van Hiele, Bruner, Bloom, Piaget, CRA, Dienes, Curcio, GAISE gibi bilimsel çerçevelere dayalı 7 araç. Kurulum yok, kayıt yok, bekleyiş yok.</p>
    <div class="dk-a-stats">
      ...
      <div class="dk-a-stat"><div class="dk-a-stat-val">∞</div><div class="dk-a-stat-lbl">Sınırsız Etkinlik</div></div>
      <div class="dk-a-stat"><div class="dk-a-stat-val">10</div><div class="dk-a-stat-lbl">Pedagoji</div></div>
    </div>
  </div>
</header>
...
<section class="dk-a-section" style="background:#f9fafb">
  <div class="wrap">
    ...
    <div class="dk-a-grid">
      ...
      <!-- 1. Sayma (en temel) -->
      <a href="/dokunsay/DokunSayBar/" class="dk-a-tool" style="--a:#F59E0B">
        <div class="dk-a-tool-head">
          <div class="dk-a-tool-icon" style="background:#F59E0B18;color:#F59E0B">🧮</div>
          <div class="dk-a-tool-meta">
            <span class="dk-a-tool-tag" style="background:#F59E0B14;color:#F59E0B">CRA + Bruner</span>
            <h3>DokunSay — Sayı Çubukları</h3>
            <div class="dk-a-tool-age">5–10 yaş</div>
          </div>
        </div>
        <p class="dk-a-tool-desc">Çubuklar ve pullarla somut sayı deneyimi.</p>
        <div class="dk-a-tool-cta">
          <span class="dk-a-tool-cta-ped">5–10 yaş</span>
          <span class="dk-a-tool-cta-go">Aracı Aç →</span>
        </div>
      </a>

      <!-- 2. Geometri (uzamsal — erken yaşta paralel başlar) -->
      <a href="/dokunsay/Dokunsay-geo/" class="dk-a-tool" style="--a:#EF4444">
        <div class="dk-a-tool-head">
          <div class="dk-a-tool-icon" style="background:#EF444418;color:#EF4444">🔺</div>
          <div class="dk-a-tool-meta">
            <span class="dk-a-tool-tag" style="background:#EF444414;color:#EF4444">Van Hiele</span>
            <h3>DokunSay — Geometri</h3>
            <div class="dk-a-tool-age">5–14 yaş</div>
          </div>
        </div>
        <p class="dk-a-tool-desc">Van Hiele düzeylerine göre şekiller.</p>
        <div class="dk-a-tool-cta">
          <span class="dk-a-tool-cta-ped">5–14 yaş</span>
          <span class="dk-a-tool-cta-go">Aracı Aç →</span>
        </div>
      </a>

      <!-- 3. Saat (zaman okuma) -->
      <a href="/dokunsay/DokunSayClock/" class="dk-a-tool" style="--a:#3B82F6">
        <div class="dk-a-tool-head">
          <div class="dk-a-tool-icon" style="background:#3B82F618;color:#3B82F6">🕐</div>
          <div class="dk-a-tool-meta">
            <span class="dk-a-tool-tag" style="background:#3B82F614;color:#3B82F6">Piaget</span>
            <h3>DokunSay — Saat</h3>
            <div class="dk-a-tool-age">6–9 yaş</div>
          </div>
        </div>
        <p class="dk-a-tool-desc">Analog saat okuma ve zaman kavramı.</p>
        <div class="dk-a-tool-cta">
          <span class="dk-a-tool-cta-ped">6–9 yaş</span>
          <span class="dk-a-tool-cta-go">Aracı Aç →</span>
        </div>
      </a>

      <!-- 4. Basamak Değeri (1-2. sınıf) -->
      <a href="/dokunsay/DokunSayBasamak/" class="dk-a-tool" style="--a:#8B5CF6">
        <div class="dk-a-tool-head">
          <div class="dk-a-tool-icon" style="background:#8B5CF618;color:#8B5CF6">🔢</div>
          <div class="dk-a-tool-meta">
            <span class="dk-a-tool-tag" style="background:#8B5CF614;color:#8B5CF6">Bloom + Dienes</span>
            <h3>DokunSay — Basamak Değeri</h3>
            <div class="dk-a-tool-age">6–10 yaş</div>
          </div>
        </div>
        <p class="dk-a-tool-desc">Birler, onlar, yüzler görselleştirme.</p>
        <div class="dk-a-tool-cta">
          <span class="dk-a-tool-cta-ped">6–10 yaş</span>
          <span class="dk-a-tool-cta-go">Aracı Aç →</span>
        </div>
      </a>

      <!-- 5. Kesirler (3-4. sınıf) -->
      <a href="/dokunsay/DokunSayKesir/" class="dk-a-tool" style="--a:#EC4899">
        <div class="dk-a-tool-head">
          <div class="dk-a-tool-icon" style="background:#EC489918;color:#EC4899">🍕</div>
          <div class="dk-a-tool-meta">
            <span class="dk-a-tool-tag" style="background:#EC489914;color:#EC4899">CRA + MEB</span>
            <h3>DokunSay — Kesirler</h3>
            <div class="dk-a-tool-age">6–10 yaş</div>
          </div>
        </div>
        <p class="dk-a-tool-desc">Pizza dilimleriyle kesir öğrenimi.</p>
        <div class="dk-a-tool-cta">
          <span class="dk-a-tool-cta-ped">6–10 yaş</span>
          <span class="dk-a-tool-cta-go">Aracı Aç →</span>
        </div>
      ...
      <!-- 6. İstatistik (4-7. sınıf) -->
      <a href="/dokunsay/Dokunsay-veri-app/" class="dk-a-tool" style="--a:#06B6D4">
        <div class="dk-a-tool-head">
          <div class="dk-a-tool-icon" style="background:#06B6D418;color:#06B6D4">📊</div>
          <div class="dk-a-tool-meta">
            <span class="dk-a-tool-tag" style="background:#06B6D414;color:#06B6D4">Curcio + GAISE</span>
            <h3>DokunSay — İstatistik ve Veri</h3>
            <div class="dk-a-tool-age">7–15 yaş</div>
          </div>
        </div>
        <p class="dk-a-tool-desc">Grafik okuma, veri analizi, olasılık.</p>
        <div class="dk-a-tool-cta">
          <span class="dk-a-tool-cta-ped">7–15 yaş</span>
          <span class="dk-a-tool-cta-go">Aracı Aç →</span>
        </div>
      </a>

      <!-- 7. Tam Sayılar (6. sınıf — en geç başlayan) -->
      <a href="/dokunsay/DokunSayTam/" class="dk-a-tool" style="--a:#10B981">
        <div class="dk-a-tool-head">
          <div class="dk-a-tool-icon" style="background:#10B98118;color:#10B981">➕➖</div>
          <div class="dk-a-tool-meta">
            <span class="dk-a-tool-tag" style="background:#10B98114;color:#10B981">Sıfır Çifti</span>
            <h3>DokunSay — Tam Sayılar</h3>
            <div class="dk-a-tool-age">10–13 yaş</div>
          </div>
        </div>
        <p class="dk-a-tool-desc">Pozitif, negatif, sıfır çifti ile işlemler.</p>
        <div class="dk-a-tool-cta">
          <span class="dk-a-tool-cta-ped">10–13 yaş</span>
          <span class="dk-a-tool-cta-go">Aracı Aç →</span>
        </div>
      </a>
...
<section class="dk-a-section" style="background:#fff">
  <div class="dk-a-cta">
    ...
    <p>Numap ile çocuğunuzu / öğrencinizi okul öncesinden ilkokul 4. sınıfa kadar (48–119 ay / 4–10 yaş) Türkiye normlarına göre bilimsel olarak değerlendirin.</p>
