...
export const tr = {
  ...
  autoGroup: "10+ grupla!",
  /* aria-label çevirileri (a11y için) */
  ariaCollapse: "Paneli daralt", ariaExpand: "Paneli aç",
  ariaPrev: "Önceki", ariaNext: "Sonraki",
  ariaItemUndo: "Bloğu geri al", ariaItemRedo: "Bloğu yeniden ekle",
  ariaInfo: "Bilgi", ariaHelp: "Yardım", ariaStats: "İstatistikler",
  ariaSpeak: "Seslendir",
  ariaVoiceStart: "Sesli komutu başlat", ariaVoiceStop: "Sesli komutu durdur",
  ariaRecord: "Kayıt", ariaRecordStop: "Kaydı durdur",
  ariaZoomIn: "Yakınlaştır", ariaZoomOut: "Uzaklaştır",
  ariaToggleGrid: "Izgarayı göster/gizle",
  ariaBgNone: "Düz arka plan", ariaBgGrid: "Izgara arka plan", ariaBgDot: "Nokta arka plan",
  ariaPlaceMore: "Bir blok ekle", ariaPlaceLess: "Bir blok azalt",
  ariaColMore: "Sütun ekle", ariaColLess: "Sütun azalt",
  ariaCloseGame: "Oyunu bitir",
  ariaMenuBlocks: "Bloklar menüsü", ariaMenuActivity: "Etkinlikler menüsü",
  ariaMenuGame: "Oyunlar menüsü", ariaMenuSettings: "Ayarlar menüsü",
  readNum: readTurkish,
  ttsLang: "tr-TR",
};
