...
export const en = {
  ...
  autoGroup: "10+ group!",
  ariaCollapse: "Collapse panel", ariaExpand: "Expand panel",
  ariaPrev: "Previous", ariaNext: "Next",
  ariaItemUndo: "Undo block", ariaItemRedo: "Redo block",
  ariaInfo: "Info", ariaHelp: "Help", ariaStats: "Statistics",
  ariaSpeak: "Read aloud",
  ariaVoiceStart: "Start voice command", ariaVoiceStop: "Stop voice command",
  ariaRecord: "Record", ariaRecordStop: "Stop recording",
  ariaZoomIn: "Zoom in", ariaZoomOut: "Zoom out",
  ariaToggleGrid: "Toggle grid",
  ariaBgNone: "Plain background", ariaBgGrid: "Grid background", ariaBgDot: "Dotted background",
  ariaPlaceMore: "Add one block", ariaPlaceLess: "Remove one block",
  ariaColMore: "Add column", ariaColLess: "Remove column",
  ariaCloseGame: "End game",
  ariaMenuBlocks: "Blocks menu", ariaMenuActivity: "Activities menu",
  ariaMenuGame: "Games menu", ariaMenuSettings: "Settings menu",
  readNum: readEnglish,
  ttsLang: "en-US",
};
