/**
 * DokunSay Tam — A11y Context (platform şablon)
 *
 * `@shared/a11y.js`'in React sarmaası: prefs, toggle, keyboard shortcuts,
 * ARIA announce. Platform genelinde aynı API'yi kullanır.
 */
...
export function A11yProvider({ children }) {
  ...
  const installShortcuts = useCallback((handlers) => {
